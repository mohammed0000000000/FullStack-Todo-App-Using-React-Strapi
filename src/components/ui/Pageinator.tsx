...
const Paginator = ({
  ...
  return (
    <div className="flex flex-col justify-center items-center my-10 mx-auto space-y-5">
      <p className="text-sm text-gray-600 mx-3">
        Page{" "}
        <span className="mx-1 font-bold text-gray-900 text-md-1">{page}</span>{" "}
        to
        <span className="mx-1 font-bold text-gray-900">{pageCount}</span> of
        <span className="mx-1 font-bold text-gray-900">{total}</span> Records
      </p>
